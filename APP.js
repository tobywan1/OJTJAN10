...
const DropdownMenuWithInputsAndVehiclesAndSubmit = () => {
  ...
  const handleCreateAccount = () => {
    ...
    if (createUsername.toLowerCase() === 'admin' && createPassword === 'adminpassword') {
      // Check for admin credentials, you can replace 'adminpassword' with your desired admin password
      alert('Admin account created. Please login before accessing the expressway.');
      setIsCreateAccount(true); // Stay on the create account form after creating the admin account
      setIsLoggedIn(false); // Admin is not automatically logged in
    } else {
  ...
  return (
    <div style={containerStyle} className='container'>
     ...
     {isLoggedIn && isAdmin ? (
        ...
        <div style={adminPageStyle} className='admin-page'>
          <h2>Add New Data</h2>
